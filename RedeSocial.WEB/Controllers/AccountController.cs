...
namespace RedeSocial.WEB.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var uriparameter = "api/Service/Verifica?id=" + usuarioID;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ViewBag.error = "Email ja Utilizado";
                    View(model);
                }
            }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                var response = await _client.PostAsJsonAsync("api/Account/ForgotPassword", model);
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            {
                var response = await _client.PostAsJsonAsync("api/Account/ResetPassword", model);
